    ...
    <el-row>
      <el-col :span="5">
          ...
          <el-form-item label="行政职务及日期 ">
            <el-input v-model="form.chiefJob" ></el-input>
            <el-date-picker
              type="date"
              placeholder="选择日期"
      ...
      <el-col :span="8">
        <el-form-item label="行政职务（管理岗位）等级及日期" label-width="136px">
          <el-select clearable v-model="form.chiefPosition" placeholder="请选择" style="max-width:167px">
            <el-option
              v-for="item in chiefPositionOptions"
              :label="item.value"
              :value="item.key"
              :key="item.key"
              style="max-width:167px"
    ...
    <el-row>
      <el-col :span="5">
        <el-form-item label="岗位等级及日期">
          <el-select clearable v-model="form.professionTechLevel" placeholder="请选择">
            <el-option
