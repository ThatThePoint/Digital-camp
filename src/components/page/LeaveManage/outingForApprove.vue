          ...
          <el-form :model="form" label-width="100px" ref="form">
            ...
            <div v-show="firstApprovalInfo">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  ...
                  <el-select clearable disabled="firstAppDisabled" v-model="form.secApprover" placeholder="审批人">
                    <el-option
            ...
            <div v-show="secondApprovalInfo">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="下一级审批人">
                  <el-select clearable disabled="secondAppDisabled"  v-model="form.thdApprover" placeholder="审批人">
                    <el-option
